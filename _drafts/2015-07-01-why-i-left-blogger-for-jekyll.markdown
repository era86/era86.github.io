...
![Jekyll Logo](/assets/images/posts/jekyll-logo.png){: .centered }
...
[![Blogger Template Designer](/assets/images/posts/blogger-template-designer.png){: .scaled-down .bordered }](/assets/images/posts/blogger-template-designer.png)
...
[![Blogger CSS Editor](/assets/images/posts/blogger-css-editor.png){: .scaled-down .bordered }](/assets/images/posts/blogger-css-editor.png)
...
[![Jekyll CSS](/assets/images/posts/jekyll-css.png){: .scaled-down .bordered }](/assets/images/posts/jekyll-css.png)

## The ability to write blog posts in almost any format

As writers, our main goal is to *produce* interesting content for readers to consume. One of the main purposes of any blogging tool is to make the delivery of great content quick and seamless. Blogger provides great tools for pumping out content, including a basic WYSIWYG (what you see is what you get) editor. With it, delivering content is as easy as writing, saving, uploading a picture or two, and clicking "Publish".

[![Blogger Post Editor](/assets/images/posts/blogger-post-editor.png){: .scaled-down .bordered }](/assets/images/posts/blogger-post-editor.png)
...
[![Blogger HTML Editor](/assets/images/posts/blogger-html-editor.png){: .scaled-down .bordered }](/assets/images/posts/blogger-html-editor.png)
...
[![Jekyll Markdown](/assets/images/posts/jekyll-markdown.png){: .scaled-down .bordered }](/assets/images/posts/jekyll-markdown.png)
...
[![Blogger Syntax Highlighting](/assets/images/posts/blogger-syntax-highlighter.png){: .scaled-down .bordered }](/assets/images/posts/blogger-syntax-highlighter.png)
...
[![Blogger Profile](/assets/images/posts/blogger-profile.png){: .scaled-down .bordered }](/assets/images/posts/blogger-profile.png)
...
[![Jekyll Profile](/assets/images/posts/jekyll-profile.png){: .scaled-down .bordered }](/assets/images/posts/jekyll-profile.png)
...
Blogger is a good platform for writers looking to quicly publish simple content. The default themes and layouts are, at the very least, pleasing to the eye. The WYSIWYG editor is adequate for delivering basic articles, with the option to edit HTML source directly.
